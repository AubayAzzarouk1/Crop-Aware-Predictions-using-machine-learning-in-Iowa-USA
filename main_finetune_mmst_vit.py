...
def main(args):
    ...
    # following timm: set wd as 0 for bias and norm 
    def add_weight_decay(model, weight_decay=1e-5, skip_list=()):
      decay, no_decay = [], []
      for name, param in model.named_parameters():
          if not param.requires_grad:
              continue  # skip frozen parameters
          # Typically, biases and parameters with a single dimension (like LayerNorm weights) are excluded from weight decay.
