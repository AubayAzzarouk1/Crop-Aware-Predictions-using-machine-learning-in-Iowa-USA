...
import timm.optim.optim_factory as add_weight_decay
...
def main(args):
    ...
    # Create the optimizer with weight_decay included
    optimizer = create_optimizer_v2(
        model_without_ddp,
        opt='adamw',       # or any supported optimizer like 'sgd', 'rmsprop', etc.
        lr=args.lr,
